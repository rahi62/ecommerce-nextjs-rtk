    ...
    return (
        <>
            ...
            <div ref={ref} className="cart-sidebar w-80 md:w-96 absolute top-0 right-0 bg-gray-100 p-10 min-h-screen transform transition-transform translate-x-full">
                <h2 className="flex text-xl font-bold text-center justify-center items-center mt-8">سبد خرید من</h2>
                ...
                <div className="lg:p-2">
                    <div className="flex item my-6 font-semibold">
                        <div className="w-2/3">آیتم</div>
                        <div className="flex w-1/3 justify-center items-center">
                            تعداد
                        </div>
                    </div>
                    <ol className="list-decimal">
                        <div className="flex justify-center items-center my-4">سبد خرید شما خالی است</div>
                        <li>
                            <div className="flex item my-4">
                                <div className="w-2/3"> نام محصول</div>
                                <div className="flex w-1/3 justify-center items-center">
                        ...
                        </li>
                        {
                            (Object.keys(cart).length === 0) ? (
                                <div className="flex justify-center items-center my-4">هیج موردی یافت نشد</div>
                            ) : (
                                <>
                                    {
                ...
                <div className="">
                    <h3 className="flex text-lg font-semibold p-4 text-center justify-center items-center mt-8">مبلغ نهایی: {totalPrice}</h3>
